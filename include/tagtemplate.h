...
public:
    ...
    static QString defaultText (TagField field)
    {
        ...
        {
            case TagField::CompanyHeader:
                return QObject::tr ("ИП Новиков А.В.");
            case TagField::Brand:
                return QObject::tr ("BRAND");
            case TagField::CategoryGender:
                return QObject::tr ("Category + Gender + Size");
            case TagField::BrandCountry:
                return QObject::tr ("Страна: ...");
            case TagField::ManufacturingPlace:
                return QObject::tr ("Место: ...");
            case TagField::MaterialLabel:
                return QObject::tr ("Матер-л:");
            case TagField::MaterialValue:
                return QObject::tr ("Материал");
            case TagField::ArticleLabel:
                return QObject::tr ("Артикул:");
            case TagField::ArticleValue:
                return QObject::tr ("VFG0005-5");
            case TagField::PriceLeft:
                return QObject::tr ("9 990");
            case TagField::PriceRight:
                return QObject::tr ("8 490 =");
            case TagField::Signature:
                return QObject::tr ("");
            case TagField::SupplierLabel:
                return QObject::tr ("Поставщик:");
            case TagField::SupplierValue:
                return QObject::tr ("ООО Рога и Копыта");
            case TagField::Address:
