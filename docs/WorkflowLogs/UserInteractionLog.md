...
[2025-10-16 10:00:00] Пользователь запросил: скорректировать дефолтную высоту ценника по сумме строк (53.97 мм) и синхронизировать с TagTemplate.json — Выполнено: обновлены include/tagtemplate.h, src/templateeditor.cpp (спинбокс 2 знака, значение 53.97), build/Debug/TagTemplate.json
[2025-10-16 10:20:00] Пользователь запросил: установить дефолтную ширину тега 40 мм — Выполнено: обновлены include/tagtemplate.h и src/templateeditor.cpp (spinTagW=40.0). TagTemplate.json уже содержит tagWidthMm=40
...
[2025-10-16 00:00:00] User requested: вставить пустую строку после последнего ценника в XLSX и расширить область печати — Выполнено: добавлен blankRow и extended print area в src/excelgenerator.cpp
...
[2025-10-24 00:00:00] Запрос пользователя: убрать ссылку на интерактивную диаграмму и вставить GIF TimeComparisonChart.gif напрямую в README — Выполнено
[2025-10-24 14:45:00] Запрос пользователя: сделать зазор между столбцами графика равным ширине одного столбца в `docs/DesignScrins/time_comparison_perfect.html` - Выполнено
[2025-10-24 14:58:00] Запрос пользователя: заменить зеленоватый фон карточек статистики под графиком на светло-серый — Выполнено
[2025-10-24 15:05:00] Запрос пользователя: заменить интерактивный график в `time_comparison_perfect.html` на актуальный `TimeComparisonChart.gif` — Выполнено
[2025-10-24 16:10:00] Запрос пользователя: заменить в README на актуальный `TimeComparisonChart.gif` — Подтверждено, README уже ссылается на `docs/DesignScrins/TimeComparisonChart.gif`; правок не требовалось
[2025-10-24 16:20:00] Запрос пользователя: удалить секцию с примерами кода из README и оставить единственный контакт email neural_dog@proton.me — Выполнено
[2025-10-24 16:35:00] Запрос пользователя: уменьшить иконку в начале README в 4 раза — Выполнено (заменено на HTML <img> с width=170)
[2025-10-24 16:50:00] Запрос пользователя: вставить изображение 'PriceTagManager – text without background.png' справа от иконки — Выполнено (HTML-таблица с двумя <img>)
[2025-10-24 17:05:00] Пользователь сообщил: картинка не отображается после удаления заголовка — Исправлено: удалены обратные кавычки вокруг <img>, добавлен центрированный HTML <img> одного логотипа PriceTagManagerLogoTestVar2
[2025-10-24 17:20:00] Запрос пользователя: заменить логотип на PriceTagManagerLogoTestVar3.png и улучшить диаграмму архитектуры — Выполнено (обновлён <img> и Mermaid с группировками UI/Core/Parsing/Generation/Output)
[2025-10-24 17:35:00] Запрос пользователя: заменить диаграмму на ASCII-схему — Выполнено (Mermaid заменён на ASCII-блок в разделе «Техническая архитектура»)
[2025-10-24 18:45:00] Запрос пользователя: оформить раздел «Техническая архитектура» в README по докам (CLAUDE.md/Implementation.md/project_structure.md/UI_UX_doc.md) - Выполнено
[2025-10-24 19:05:00] Запрос пользователя: переработать «Демонстрация функционала» и вынести скрины Word/XLSX в «Результат работы» - Выполнено
[2025-10-24 20:00:00] Пользователь запросил красивую схему потока данных (рантайм) в README вместо ASCII - Выполнено: вставлена Mermaid-диаграмма с ветвлением (Статистика/Редактор/Экспорт DOCX|XLSX)
[2025-10-24 20:05:30] Пользователь сообщил: Mermaid в README даёт "Syntax error in graph" - Исправлено: обновлена диаграмма (без угловых скобок и нестабильных символов)