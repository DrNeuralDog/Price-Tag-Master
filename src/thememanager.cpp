...
QString ThemeManager::buildLightQss ()
{
    const char *qss = R"(
     ...
     QTabBar::tab { background: #FFFFFF; color: #0F172A; padding: 6px 10px; border: 1px solid #E2E8F0; border-bottom: none; }
     QTabBar::tab:selected { background: #F1F5F9; }
     QPushButton { height: 32px; padding: 0 12px; border-radius: 4px; border: 1px solid #CBD5E1; background: #FFFFFF; color: #0F172A; font-weight: 600; }
     ...
     QLineEdit, QComboBox, QTextEdit, QPlainTextEdit { height: 32px; border: 1px solid #E2E8F0; border-radius: 4px; background: #FFFFFF; color: #0F172A; padding: 2px 8px; }
     QProgressBar { border: 1px solid #E2E8F0; border-radius: 4px; text-align: center; background: #FFFFFF; }
     QProgressBar::chunk { background-color: #3B82F6; }
     QTableWidget { background: #FFFFFF; alternate-background-color: #F1F5F9; gridline-color: #E2E8F0; }
     QHeaderView::section { background: #F1F5F9; color: #0F172A; border: 1px solid #E2E8F0; padding: 4px 6px; }
...
QString ThemeManager::buildDarkQss ()
{
    const char *qss = R"(
     ...
     QTabBar::tab { background: #0F172A; color: #E5E7EB; padding: 6px 10px; border: 1px solid #334155; border-bottom: none; }
     QTabBar::tab:selected { background: #1F2937; }
     QPushButton { height: 32px; padding: 0 12px; border-radius: 4px; border: 1px solid #475569; background: #0F172A; color: #E5E7EB; font-weight: 600; }
     QPushButton:hover { background: #1F2937; }
     QPushButton:disabled { background: #111827; color: #64748B; border-color: #334155; }
     QPushButton#primary { background: #3B82F6; color: #0F172A; border: 1px solid #3B82F6; }
     QLineEdit, QComboBox, QTextEdit, QPlainTextEdit { height: 32px; border: 1px solid #334155; border-radius: 4px; background: #0F172A; color: #E5E7EB; padding: 2px 8px; }
     QProgressBar { border: 1px solid #334155; border-radius: 4px; text-align: center; background: #0F172A; }
     ...
     QHeaderView::section { background: #1F2937; color: #E5E7EB; border: 1px solid #334155; padding: 4px 6px; }
